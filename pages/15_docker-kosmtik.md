...
Kosmtik is a [node](https://en.wikipedia.org/wiki/Node.js) module needing a list of prerequisite software like PostgreSQL, PostGIS, Python, osm2pgsql and Node.js itself. It includes node versions of prerequisite software like Mapnik and Carto and at the moment it supports Ubuntu. To simplify the related installation process, openstreetmap-carto comes with [Docker](https://en.wikipedia.org/wiki/Docker_(software)) files and [documentation](https://github.com/Ircama/openstreetmap-carto/blob/docker/DOCKER.md), which allow to build the image through simple commands.
