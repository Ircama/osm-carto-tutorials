...
To install [Node.js](https://nodejs.org/en/):
    ...
    sudo apt-get install nodejs npm # this package might not support TileMill, see notes in this paragraph

Read [nodejs](https://nodejs.org/en/download/) for further information.

Notice that *nodejs-legacy* might be needed for TileMill (at least required with Ubuntu 16.04 at the time of writing).
